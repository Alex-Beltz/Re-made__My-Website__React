...
import "../styles/TextToVoiceTool.css";
...
export default function TextToVoiceTool() {
  ...
  const textToSpeech = async (text) => {
    return new Promise((resolve) => {
      ...
      speak({
        ...
        voice: selectedVoice,
        onEnd: (event) => {
          const audioBlob = new Blob([event.target.getBlob()], {
            type: "audio/mpeg",
          });
          resolve(audioBlob);
        },
  ...
  return (
    <div className="textToVoiceToolContainer">
      ...
      <div
        className="textAreaDropBox shadow"
        onDrop={handleTextAreaDrop}
        onDragOver={(event) => event.preventDefault()}
      >
        <textarea
          style={{ height: "500px", width: "500px", resize: "none" }}
          value={inputText}
        ...
        {audioData ? (
          <>
            <p className="textAreaDropBoxText">Conversion complete</p>
